...
/// <summary>
/// An 8-bit RGB PNG, written by hand.
///
...
///
/// It is not a general encoder and does not try to be. One colour type (truecolour RGB), one bit
/// depth (8), filter 0 on every scanline, everything in a single IDAT. That is a valid PNG by the
/// spec's own reading and it is what a bake needs; adding filters would shrink the file and is not
/// worth a byte of the complexity until something is actually short of disk.
///
