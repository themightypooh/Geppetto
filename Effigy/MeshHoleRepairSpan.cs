...
/// away and the opening stayed open. WHAT-IS-LEFT called this out: "a cut meeting an edge, so the
/// mouth spans two faces — the honest fix is to split the loop where it crosses an edge."
///
