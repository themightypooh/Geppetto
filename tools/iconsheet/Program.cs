...
// every glyph is drawn at the centre of a 54x54 square at scale 1.5 - the same numbers the strip
...
{
	/// <summary>EffigyToolStrip.ButtonSize.</summary>
	private const float ButtonSize = 54f;

	/// <summary>EffigyToolStrip.IconScale.</summary>
...
the strip's real geometry: a 54&times;54 button with the glyph at scale 1.5. Left swatch is the
