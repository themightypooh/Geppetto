...
/// never had one, and WHAT-IS-LEFT was right to file it as "unverified, not missing" rather than
/// guess at it: a wrong KV3 node fails as a model that will not load, which is worse than a model
/// missing a node.
/// </summary>
