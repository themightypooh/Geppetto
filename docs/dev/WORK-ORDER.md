...
~25 seconds, **2099 checks, 0 failing** as of this writing. `dotnet` is installed but not on `PATH`
...
Diagnostics have landed (kernel + dialog + tests; `DIAGNOSTICS-BRIEF.md` is deleted). Tamagotchi,
Pipeline, and HaloMount are gitignored personal work. Leave them alone.
